...
export function AvatarCropModal({
  ...
  return (
    <div ref={dialogRef} className="fixed inset-0 z-[1100] flex flex-col bg-black animate-in fade-in duration-200 touch-none" role="dialog" aria-modal="true" aria-label="Обрезка фото профиля">

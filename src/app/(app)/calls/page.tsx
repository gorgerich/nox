...
export default async function CallsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl py-12 px-4 transition-smooth">
      <div className="mb-12">
        <h1 className="text-3xl font-extrabold tracking-tight">Звонки</h1>
        <p className="mt-2 text-sm text-muted/60 font-medium">Ваша история аудиовызовов</p>
      </div>

      <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in-95 duration-700">
        <div className="mb-8 flex h-24 w-24 items-center justify-center rounded-[2.5rem] bg-surface-hover/30 border border-border-subtle/50 shadow-inner">

        ...
        {!message && (
          <div className="flex gap-4">
            <button 
              onClick={handleDeny} 
              disabled={pending}
              className="flex-1 py-4 font-black uppercase tracking-widest text-xs rounded-xl bg-danger/10 text-danger transition-smooth active:scale-95 disabled:opacity-50"
            >
              Отклонить
            </button>
            <button 

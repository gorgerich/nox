...
export function ChatComposer({
  ...
  // Use editingTo.body as initial text if it exists
  ...
  if (isLocked) {
    return (
      <div className="p-4 glass-composer">
        <div className="rounded-2xl bg-neutral-900/50 p-4 text-center border border-white/5">
          <p className="text-[10px] font-bold uppercase tracking-widest text-muted">Чат закрыт для участников</p>
        </div>
      </div>
    );
  }

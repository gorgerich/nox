  ...
  return (
    ...
    >
      <header className="liquid-top-chrome sticky top-0 z-50">
        <div className="relative mx-auto flex min-h-14 w-full max-w-[48rem] items-center px-1">
          <button
            type="button"
            onClick={onBack}
            className="fast-tap flex h-11 items-center gap-0.5 rounded-full pl-2 pr-3 text-[1.0625rem] text-primary transition-colors hover:bg-primary/8"
          >
      ...
      <div className="mx-auto w-full max-w-[48rem] pb-[calc(var(--bottom-dock-clearance)+1rem)] pt-2">
        {children}
      </div>
    </div>
  );
